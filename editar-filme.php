...
$sqlRegistros = mysqli_query($conexao,"select tituloFilme,duracaoFilme,valorLocacao, tbFilmes.idCategoria, nomeCategoria from tbFilmes
inner join tbCategorias on tbFilmes.idCategoria = tbCategorias.idCategoria where
idFilme=$idFilme") or die ("Errona execusão da consulta" . mysqli_error($conexao));
